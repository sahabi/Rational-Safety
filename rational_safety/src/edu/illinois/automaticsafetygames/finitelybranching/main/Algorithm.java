...
import edu.illinois.automaticsafetygames.games.examples.FMCAD2015Example;
import edu.illinois.automaticsafetygames.games.examples.FMCAD2015ExampleMixed;
import edu.illinois.automaticsafetygames.games.examples.DiagonalGame;
import edu.illinois.automaticsafetygames.games.examples.FMCAD2015ExampleFinite;
import edu.illinois.automaticsafetygames.games.examples.EvasionGame;
import edu.illinois.automaticsafetygames.games.examples.Follow2D;
import edu.illinois.automaticsafetygames.games.examples.ProgramRepairGame;
import edu.illinois.automaticsafetygames.games.examples.BoxGame;
import edu.illinois.automaticsafetygames.games.examples.SolitaryBoxGame;
import edu.illinois.automaticsafetygames.games.examples.GridWorldSequence1D;
import edu.illinois.automaticsafetygames.games.examples.CopyOfGridWorldSequence2D;
import edu.illinois.automaticsafetygames.games.examples.GridWorldSequence1Da;
import edu.illinois.automaticsafetygames.games.examples.GridWorldSequence2D;
import edu.illinois.automaticsafetygames.games.examples.GridWorldSequence2Da;
...
public class Algorithm {
	...
	public static void main(String[] args) throws Exception {
		...
		IGame game = new CopyOfGridWorldSequence2D(world);
		...
		System.out.println(String.format("Created game in %,.3f s",
				(double) gameWatch.stop() / (double) StopWatch.IN_SECONDS));
		System.out
				.println("Combined size of game is " + Tools.sizeOfGame(game));

(define (problem GWS_2D_pb) 
 	 (:domain GWS_2D)  
 	 (:requirements :strips :conditional-effects :negative-preconditions :disjunctive-preconditions) 
 	     (:objects s0 e0 s1 e1 s2 e2 s3 e3 s4 e4 s5 e5 s6 e6 s7 e7 s8 e8 s9 e9 s10 e10 s11 e11 s12 e12 s13 e13 s14 e14 s15 e15 ) 
...
(and (not(P0TRAN)) (robot_E_position e10) (not(robot_S_position s10)))
(and (not(P0TRAN)) (robot_E_position e11) (not(robot_S_position s11)))
(and (not(P0TRAN)) (robot_E_position e12) (not(robot_S_position s12)))
(and (not(P0TRAN)) (robot_E_position e13) (not(robot_S_position s13)))
(and (not(P0TRAN)) (robot_E_position e14) (not(robot_S_position s14)))
(and (not(P0TRAN)) (robot_E_position e15) (not(robot_S_position s15)))
)))